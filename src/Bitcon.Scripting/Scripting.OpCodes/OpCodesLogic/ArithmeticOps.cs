...
namespace Scripting.OpCodes.OpCodesLogic
{
    public class ArithmeticOps
    {
        ...
        public static long Decrement(long a)
        {
            return --a;
        }
        ...
        public static bool IsNotZero(long a)
        {
            return a == 0L;
        }

        public static bool OP_BOOLAND(long a, long b)
        {
            return a != 0L && b != 0L;
        }

        public static bool OP_BOOLOR(long a, long b)
        {
            return a != 0L || b != 0L;
        }

        public static bool OP_NUMEQUAL(long a, long b)
        {
            return a == b;
        }

        public static bool OP_NUMNOTEQUAL(long a, long b)
        {
            return a != b;
        }
        ...
        public static long OP_MIN(long a, long b)
        {
            return Math.Min(a, b);
        }

        public static long OP_MAX(long a, long b)
        {
            return Math.Max(a, b);
        }

        public static bool OP_WITHIN(long x, long min, long max)
        {
            return min <= x && x <= max;
        }
    }
