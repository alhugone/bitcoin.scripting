...
public class BNumberCompilerTests
{
    ...
    private readonly BNumberCompiler _cut;
    private readonly Random _random = new();
    public BNumberCompilerTests() => _cut = new BNumberCompiler(_byteCompiler);
    ...
    [Fact]
    public void PassesComputedDataToByteCompilerAndReturnsItsResult()
    {
        var byteCode = _cut.ToByteCode(_random.Next());
        // assert
